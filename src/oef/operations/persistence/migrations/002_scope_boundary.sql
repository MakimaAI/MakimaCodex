CREATE TABLE IF NOT EXISTS operation_jobs_v2 (
  job_id TEXT NOT NULL, scope_id TEXT NOT NULL, kind TEXT NOT NULL, idempotency_key TEXT NOT NULL, payload_json TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS operation_jobs_v2_claimable ON operation_jobs_v2(scope_id, state, available_at, priority DESC, created_at);
CREATE INDEX IF NOT EXISTS operation_jobs_v2_expiring ON operation_jobs_v2(scope_id, state, lease_expires_at);
CREATE TABLE IF NOT EXISTS operation_attempts_v2 (
  attempt_id TEXT PRIMARY KEY, scope_id TEXT NOT NULL, job_id TEXT NOT NULL, attempt_number INTEGER NOT NULL, owner TEXT NOT NULL,
  ...
  UNIQUE(scope_id, job_id, attempt_number), FOREIGN KEY(scope_id, job_id) REFERENCES operation_jobs_v2(scope_id, job_id)
);
CREATE TABLE IF NOT EXISTS operation_effect_receipts_v2 (
  ...
  PRIMARY KEY(scope_id, job_id), FOREIGN KEY(scope_id, job_id) REFERENCES operation_jobs_v2(scope_id, job_id)
);
