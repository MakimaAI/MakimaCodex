...
export const en = {
  ...
  "prov.clineDesc": "Sign in to a Cline account. Usage is billed by Cline; 402/429 can switch to another connected account.",
  "prov.clinePassDesc": "Use a Cline API key with your ClinePass subscription. Multiple keys can fail over on 402/429.",
  ...
  "sub.bridgeHealthy": "Healthy",
  "sub.bridgeNeedsAttention": "Needs attention",
  "sub.bridgeInstalled": "Installation",
  "sub.bridgeRegistered": "Codex registration",
  "sub.bridgeEnabled": "Configuration",
  "sub.bridgeSecurity": "Authentication security",
  "sub.bridgeInstalledYes": "Installed",
  "sub.bridgeMissing": "Missing",
  "sub.bridgeRegisteredYes": "Registered",
  "sub.bridgeRegisteredNo": "Not registered",
  "sub.bridgeEnabledYes": "Enabled",
  "sub.bridgeDisabled": "Disabled",
  "sub.bridgeSecuritySecure": "Secure",
  "sub.bridgeSecurityInsecure": "Insecure",
  "sub.bridgeSecurityUnknown": "Unknown",
  "sub.bridgeInstallGuidance": "Install or repair the companion bridge with {cmd}. Installation is intentionally command-line only.",
  "sub.bridgeRestartGuidance": "Then run {cmd} and start a new Codex task.",
  "sub.bridgeWarnings": "Bridge notices",
  "sub.bridgeWarningNotInstalled": "The companion bridge is not installed.",
  "sub.bridgeWarningMcpInvalid": "The bridge launcher is missing or invalid.",
  "sub.bridgeWarningMarketplace": "The local bridge marketplace entry needs repair.",
  "sub.bridgeWarningRegistration": "The bridge is not registered and enabled in Codex.",
  "sub.bridgeWarningTokenMissing": "Bridge authentication is missing or invalid.",
  "sub.bridgeWarningTokenInsecure": "Bridge authentication permissions are insecure.",
  "sub.bridgeWarningTokenUnknown": "Bridge authentication security could not be verified.",
  "sub.bridgeWarningDisabled": "The bridge is disabled in opencodex.",
  "sub.bridgeWarningModelNotSelected": "A routed model is not in the selected V2 roster.",
  "sub.bridgeWarningNotReady": "The bridge is not ready for routed V2 subagents.",
  "sub.bridgeWarningV1Required": "A selected model is not V2-eligible in the active Codex catalog.",
  "sub.bridgeWarningUnknown": "The bridge reported an additional issue. Check bridge status from the command line for details.",
  "sub.modelV2Ready": "V2 ready",
  "sub.modelV1Required": "V1 required",
  "sub.modelBridgeRequired": "Bridge required",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.clineAccountHint": "The selected account is used first. On a usage or rate limit (402/429), Cline can continue with the next connected account.",
  "pws.clinePassHint": "Add one or more Cline API keys. ClinePass models use your subscription and can continue with the next key on 402/429.",
  ...
  "pws.showRawReasoning": "Show raw reasoning",
  "pws.showRawReasoningWarning": "Raw reasoning may be long and can contain sensitive content, including instructions or other internal details.",
