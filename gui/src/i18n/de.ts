...
export const de = {
  ...
  "prov.clineDesc": "Mit einem Cline-Konto anmelden. Die Nutzung wird von Cline abgerechnet; bei 402/429 kann zu einem anderen verbundenen Konto gewechselt werden.",
  "prov.clinePassDesc": "Einen Cline-API-Schlüssel mit dem ClinePass-Abo verwenden. Mehrere Schlüssel können bei 402/429 automatisch wechseln.",
  ...
  "sub.bridgeTitle": "V2-Subagent-Bridge",
  "sub.bridgeHealthy": "Bereit",
  "sub.bridgeNeedsAttention": "Aktion erforderlich",
  "sub.bridgeInstalled": "Installation",
  "sub.bridgeRegistered": "Codex-Registrierung",
  "sub.bridgeEnabled": "Konfiguration",
  "sub.bridgeSecurity": "Authentifizierungssicherheit",
  "sub.bridgeInstalledYes": "Installiert",
  "sub.bridgeMissing": "Fehlt",
  "sub.bridgeRegisteredYes": "Registriert",
  "sub.bridgeRegisteredNo": "Nicht registriert",
  "sub.bridgeEnabledYes": "Aktiviert",
  "sub.bridgeDisabled": "Deaktiviert",
  "sub.bridgeSecuritySecure": "Sicher",
  "sub.bridgeSecurityInsecure": "Unsicher",
  "sub.bridgeSecurityUnknown": "Unbekannt",
  "sub.bridgeInstallGuidance": "Installiere oder repariere die Companion-Bridge mit {cmd}. Die Installation ist absichtlich nur über die Befehlszeile möglich.",
  "sub.bridgeRestartGuidance": "Führe danach {cmd} aus und starte eine neue Codex-Aufgabe.",
  "sub.bridgeWarnings": "Bridge-Hinweise",
  "sub.bridgeWarningNotInstalled": "Die Companion-Bridge ist nicht installiert.",
  "sub.bridgeWarningMcpInvalid": "Der Bridge-Starter fehlt oder ist ungültig.",
  "sub.bridgeWarningMarketplace": "Der lokale Marketplace-Eintrag der Bridge muss repariert werden.",
  "sub.bridgeWarningRegistration": "Die Bridge ist in Codex nicht registriert und aktiviert.",
  "sub.bridgeWarningTokenMissing": "Die Bridge-Authentifizierung fehlt oder ist ungültig.",
  "sub.bridgeWarningTokenInsecure": "Die Berechtigungen der Bridge-Authentifizierung sind unsicher.",
  "sub.bridgeWarningTokenUnknown": "Die Sicherheit der Bridge-Authentifizierung konnte nicht überprüft werden.",
  "sub.bridgeWarningDisabled": "Die Bridge ist in opencodex deaktiviert.",
  "sub.bridgeWarningModelNotSelected": "Ein geroutetes Modell ist nicht im ausgewählten V2-Kader enthalten.",
  "sub.bridgeWarningNotReady": "Die Bridge ist für geroutete V2-Subagents nicht bereit.",
  "sub.bridgeWarningV1Required": "Ein ausgewähltes Modell ist im aktiven Codex-Katalog nicht V2-fähig.",
  "sub.bridgeWarningUnknown": "Die Bridge hat ein weiteres Problem gemeldet. Prüfe den Bridge-Status über die Befehlszeile.",
  "sub.modelV2Ready": "V2 bereit",
  "sub.modelV1Required": "V1 erforderlich",
  "sub.modelBridgeRequired": "Bridge erforderlich",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "pws.clineAccountHint": "Das ausgewählte Konto wird zuerst verwendet. Bei Nutzungs- oder Ratenlimits (402/429) kann Cline mit dem nächsten verbundenen Konto fortfahren.",
  "pws.clinePassHint": "Einen oder mehrere Cline-API-Schlüssel hinzufügen. ClinePass-Modelle nutzen das Abo und können bei 402/429 mit dem nächsten Schlüssel fortfahren.",
  ...
  "pws.showRawReasoning": "Ungefilterte Reasoning-Inhalte anzeigen",
  "pws.showRawReasoningWarning": "Ungefilterte Reasoning-Inhalte können lang sein und vertrauliche Inhalte enthalten, einschließlich Anweisungen oder anderer interner Details.",
