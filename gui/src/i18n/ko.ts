...
export const ko: Record<TKey, string> = {
  ...
  "prov.clineDesc": "Cline 계정으로 로그인합니다. 사용량은 Cline에서 청구되며 402/429 발생 시 연결된 다른 계정으로 전환할 수 있습니다.",
  "prov.clinePassDesc": "ClinePass 구독용 Cline API 키를 사용합니다. 402/429 발생 시 여러 키 사이에서 자동 전환할 수 있습니다.",
  ...
  "sub.removeAria": "{m} 삭제",
  "sub.bridgeTitle": "V2 서브에이전트 브리지",
  "sub.bridgeHealthy": "정상",
  "sub.bridgeNeedsAttention": "조치 필요",
  "sub.bridgeInstalled": "설치",
  "sub.bridgeRegistered": "Codex 등록",
  "sub.bridgeEnabled": "구성",
  "sub.bridgeSecurity": "인증 보안",
  "sub.bridgeInstalledYes": "설치됨",
  "sub.bridgeMissing": "없음",
  "sub.bridgeRegisteredYes": "등록됨",
  "sub.bridgeRegisteredNo": "등록되지 않음",
  "sub.bridgeEnabledYes": "활성화됨",
  "sub.bridgeDisabled": "비활성화됨",
  "sub.bridgeSecuritySecure": "안전함",
  "sub.bridgeSecurityInsecure": "안전하지 않음",
  "sub.bridgeSecurityUnknown": "알 수 없음",
  "sub.bridgeInstallGuidance": "{cmd} 명령으로 컴패니언 브리지를 설치하거나 복구하세요. 설치는 의도적으로 명령줄에서만 가능합니다.",
  "sub.bridgeRestartGuidance": "그런 다음 {cmd} 명령을 실행하고 새 Codex 작업을 시작하세요.",
  "sub.bridgeWarnings": "브리지 알림",
  "sub.bridgeWarningNotInstalled": "컴패니언 브리지가 설치되지 않았습니다.",
  "sub.bridgeWarningMcpInvalid": "브리지 실행기가 없거나 올바르지 않습니다.",
  "sub.bridgeWarningMarketplace": "로컬 브리지 마켓플레이스 항목을 복구해야 합니다.",
  "sub.bridgeWarningRegistration": "브리지가 Codex에 등록 및 활성화되지 않았습니다.",
  "sub.bridgeWarningTokenMissing": "브리지 인증이 없거나 올바르지 않습니다.",
  "sub.bridgeWarningTokenInsecure": "브리지 인증 권한이 안전하지 않습니다.",
  "sub.bridgeWarningTokenUnknown": "브리지 인증 보안을 확인할 수 없습니다.",
  "sub.bridgeWarningDisabled": "opencodex에서 브리지가 비활성화되어 있습니다.",
  "sub.bridgeWarningModelNotSelected": "라우팅된 모델이 선택한 V2 명단에 없습니다.",
  "sub.bridgeWarningNotReady": "브리지가 라우팅된 V2 서브에이전트에 사용할 준비가 되지 않았습니다.",
  "sub.bridgeWarningV1Required": "선택한 모델은 활성 Codex 카탈로그에서 V2를 지원하지 않습니다.",
  "sub.bridgeWarningUnknown": "브리지에서 추가 문제를 보고했습니다. 자세한 내용은 명령줄에서 브리지 상태를 확인하세요.",
  "sub.modelV2Ready": "V2 준비됨",
  "sub.modelV1Required": "V1 필요",
  "sub.modelBridgeRequired": "브리지 필요",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.clineAccountHint": "선택한 계정을 먼저 사용합니다. 사용량 또는 속도 제한(402/429)에 도달하면 다음 연결 계정으로 계속할 수 있습니다.",
  "pws.clinePassHint": "Cline API 키를 하나 이상 추가하세요. ClinePass 모델은 구독을 사용하며 402/429 발생 시 다음 키로 계속할 수 있습니다.",
  ...
  "pws.showRawReasoning": "원시 추론 표시",
  "pws.showRawReasoningWarning": "원시 추론은 길 수 있으며 지침이나 기타 내부 세부 정보 등 민감한 내용을 포함할 수 있습니다.",
