...
export const zh: Record<TKey, string> = {
  ...
  "prov.clineDesc": "登录 Cline 账户。用量由 Cline 计费；遇到 402/429 时可切换到其他已连接账户。",
  "prov.clinePassDesc": "使用 ClinePass 订阅的 Cline API 密钥。多个密钥可在 402/429 时自动切换。",
  ...
  "sub.moveDown": "下移 {m}",
  "sub.removeAria": "移除 {m}",
  "sub.bridgeTitle": "V2 子代理桥接器",
  "sub.bridgeHealthy": "状态正常",
  "sub.bridgeNeedsAttention": "需要处理",
  "sub.bridgeInstalled": "安装",
  "sub.bridgeRegistered": "Codex 注册",
  "sub.bridgeEnabled": "配置",
  "sub.bridgeSecurity": "身份验证安全性",
  "sub.bridgeInstalledYes": "已安装",
  "sub.bridgeMissing": "缺失",
  "sub.bridgeRegisteredYes": "已注册",
  "sub.bridgeRegisteredNo": "未注册",
  "sub.bridgeEnabledYes": "已启用",
  "sub.bridgeDisabled": "已禁用",
  "sub.bridgeSecuritySecure": "安全",
  "sub.bridgeSecurityInsecure": "不安全",
  "sub.bridgeSecurityUnknown": "未知",
  "sub.bridgeInstallGuidance": "使用 {cmd} 安装或修复配套桥接器。安装操作仅允许通过命令行执行。",
  "sub.bridgeRestartGuidance": "然后运行 {cmd} 并启动一个新的 Codex 任务。",
  "sub.bridgeWarnings": "桥接器提示",
  "sub.bridgeWarningNotInstalled": "配套桥接器尚未安装。",
  "sub.bridgeWarningMcpInvalid": "桥接器启动程序缺失或无效。",
  "sub.bridgeWarningMarketplace": "本地桥接器市场条目需要修复。",
  "sub.bridgeWarningRegistration": "桥接器尚未在 Codex 中注册并启用。",
  "sub.bridgeWarningTokenMissing": "桥接器身份验证缺失或无效。",
  "sub.bridgeWarningTokenInsecure": "桥接器身份验证权限不安全。",
  "sub.bridgeWarningTokenUnknown": "无法验证桥接器身份验证的安全性。",
  "sub.bridgeWarningDisabled": "桥接器已在 opencodex 中禁用。",
  "sub.bridgeWarningModelNotSelected": "某个已路由模型不在所选 V2 名单中。",
  "sub.bridgeWarningNotReady": "桥接器尚未准备好用于已路由的 V2 子代理。",
  "sub.bridgeWarningV1Required": "某个已选模型在当前 Codex 目录中不支持 V2。",
  "sub.bridgeWarningUnknown": "桥接器报告了其他问题。请在命令行中查看桥接器状态以了解详情。",
  "sub.modelV2Ready": "V2 已就绪",
  "sub.modelV1Required": "需要 V1",
  "sub.modelBridgeRequired": "需要桥接器",
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "pws.clineAccountHint": "优先使用所选账户。遇到用量或速率限制（402/429）时，可继续使用下一个已连接账户。",
  "pws.clinePassHint": "添加一个或多个 Cline API 密钥。ClinePass 模型使用订阅，并可在 402/429 时切换到下一个密钥。",
  ...
  "pws.showRawReasoning": "显示原始推理",
  "pws.showRawReasoningWarning": "原始推理可能很长，并且可能包含敏感内容，包括指令或其他内部细节。",
